...
public class JavaCurrencyFormatter {
    public static void main(String[] args) {
        ...
        Locale locale_China = new Locale("zh", "CN");
        Locale locale_France = new Locale("fr", "FR");
        ...
        String china = NumberFormat.getCurrencyInstance(locale_China).format(payment);
        String france = NumberFormat.getCurrencyInstance(locale_France).format(payment);
